...
//SoftwareSerial cell(0,1);  //Create a 'fake' serial port. Pin 2 is the Rx pin, pin 3 is the Tx pin.
...
void loop() {
  ...
  {
    incoming_char=Serial3.read();    //Get the character from the cellular serial port.
  ...
  if(Serial.available() >0)
  {
    ...
    Serial3.print(incoming_char);    //Send the character to the cellular module.
  }
}
